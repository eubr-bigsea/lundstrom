...
from util import sub_unix_timestamps, sub_datetimes, read_files, parse_stages_as_tree, hash_tree, datetime_to_unix_timestamp, write_file_from_matrix
...
def parse_DAG(logPath):
	...
	return sub_datetimes(end, start), stages
